...
use crate::adapter::bltp::state::causal::{CausalChainBuilder, CausalEvent};
use crate::adapter::bltp::state::horizon::ObservedHorizon;
use crate::adapter::bltp::state::snapshot::StateSnapshot;
...
impl DaemonHost {
    ...
    #[inline]
    pub fn entity_id(&self) -> &crate::adapter::bltp::identity::EntityId {
