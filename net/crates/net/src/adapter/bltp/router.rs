//! BLTP Router for single-hop and multi-hop packet routing.
//!
//! The router handles:
...
#[cfg(test)]
mod tests {
    use super::super::protocol::BltpHeader;
    use super::*;
    ...
    async fn test_router_creation() {
        ...
        let router = BltpRouter::new(config).await.unwrap();
    ...
    async fn test_router_extracts_stream_id_at_correct_offset() {
        ...
        // instead of bytes 40..48 where it actually lives in the BLTP header.
        ...
        // Build a BLTP header with a known stream_id
        let bltp = BltpHeader::new(
            0xAAAA,             // session_id
