...
use crate::adapter::nltp::channel::{ChannelConfigRegistry, Visibility};
...
mod tests {
    use super::*;
    use crate::adapter::nltp::channel::{ChannelConfig, ChannelId};

    use crate::adapter::nltp::channel::ChannelName;
