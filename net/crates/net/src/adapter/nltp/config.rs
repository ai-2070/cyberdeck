//! Configuration for the NLTP adapter.
...
/// Reliability configuration for NLTP streams.
...
mod tests {
    ...
    fn test_responder_config() {
        ...
        let config = NltpAdapterConfig::responder(
            "127.0.0.1:9001".parse().unwrap(),
            "127.0.0.1:9000".parse().unwrap(),
            psk,
            keypair,
    ...
    fn test_responder_missing_keypair() {
        ...
        let mut config = NltpAdapterConfig::responder(
            "127.0.0.1:9001".parse().unwrap(),
            "127.0.0.1:9000".parse().unwrap(),
            psk,
            keypair,
