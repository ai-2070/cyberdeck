...
Channels use hierarchical names with `/` separators (e.g., `sensors/lidar/front`). The `channel_hash: u16` in the NLTP header is derived via xxh3 truncation for wire-speed filtering.
