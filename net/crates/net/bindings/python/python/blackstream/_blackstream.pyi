"""Type stubs for blackstream native module."""
...
class Blackstream:
    ...
    def __init__(
        ...
        bltp_bind_addr: Optional[str] = None,
        bltp_peer_addr: Optional[str] = None,
        bltp_psk: Optional[str] = None,
        bltp_role: Optional[str] = None,
        bltp_peer_public_key: Optional[str] = None,
        bltp_secret_key: Optional[str] = None,
        bltp_public_key: Optional[str] = None,
        bltp_reliability: Optional[str] = None,
        bltp_heartbeat_interval_ms: Optional[int] = None,
        bltp_session_timeout_ms: Optional[int] = None,
        bltp_batched_io: Optional[bool] = None,
        bltp_packet_pool_size: Optional[int] = None,
    ) -> None:
        """
    ...
    def __enter__(self) -> "Blackstream": ...
