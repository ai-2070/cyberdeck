...
The entire transport library - Noise protocol, ChaCha20-Poly1305 encryption, routing, swarm discovery, failure detection, capability system - compiles to ~860 KB stripped. Under a megabyte. It fits on anything with a network interface.
